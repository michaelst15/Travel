                         ...
                         <Button onClick={handleOpen} id="btn-booking">Booking</Button>
                           ...
                           >
                             <Box className="pop-booking">
                              ...
                              <Button id="btn-via-pesawat" sx={{ marginLeft: '31px', marginTop: '10px' }} onClick={() => navigate('/pesawat')}>Via Pesawat</Button>
                              </div>
                              <br />
                              <div style={{ display: 'flex' }}>
                               <img src={TrainModal} alt="" style={{ width: '30px', marginLeft: '65px' }} /> 
                              <Button id="btn-via-kereta" sx={{ marginLeft: '23px', marginTop: '5px' }} onClick={() => navigate("/kereta")}>Via Kereta</Button>
                              </div>
                             </Box>
                           </Modal>
                       </Box> 
